...
//        Draw.drawFullShape(4);
        ...
        sq.draw();
        sq.draw("blue");
        Student student = new Student("Andrei Circov", "111111111111114", Gender.MASCULIN, "1234", "IT");
        Teacher teacher = new Teacher("Adelina Maniu", "211222567896543", Gender.FEMININ, "2", "Math");
